...
3. **Global Object Storage**: Reusable object storage backend that Simulates S3/MinIO bucket hierarchies locally on disk.
...
-   [docker-compose-dev.yml](file:///c:/Users/akliv/Desktop/AkeshPersonal/ChatBot/docker-compose-dev.yml) - Local development stack (Database, MinIO, CloudBeaver, ChatBot App).
